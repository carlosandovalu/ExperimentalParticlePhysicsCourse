...
void Selection::define_histograms()
{
  // HISTOGRAMS
...
////////////////////////////////////////////////////////////////////////////////
void Selection::WriteHistograms()
{
  // histograms
...
void Selection::FillHistogramsGlobal( double m, float w , TString s)
{
...
void Selection::FillHistogramsTTbar( double m, float w , TString s)
{
...
void Selection::FillHistogramsLeadlept( double m, float w , TString s)
{
  //Leading lepton histograms
...
void Selection::FillHistogramsLeadJet( double m, float w , TString s)
{
