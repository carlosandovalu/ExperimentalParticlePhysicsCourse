...
void main_Selection(int proof = 0, int option= 0)
{
  ...
  if (option==11 || option==0){
    ...
    chain_dataA->Process("Selection.C+","dataA");
  }
  ...
  if (option==12 || option==0){
    ...
    chain_dataB->Process("Selection.C+","dataB");
  }
  ...
  if (option==13 || option==0){
    ...
    chain_dataC->Process("Selection.C+","dataC");
  }
  ...
  if (option==14 || option==0){
    ...
    chain_dataD->Process("Selection.C+","dataD");
  }
  ...
  if (option==2 || option==0)   {
    ...
    chain_ZqqZll->Process("Selection.C+","ZqqZll");
    ...
    chain_WqqZll->Process("Selection.C+","WqqZll");
    ...
    chain_WpqqWmlv->Process("Selection.C+","WpqqWmlv");
    ...
    chain_WplvWmqq->Process("Selection.C+","WplvWmqq");
    ...
    chain_Ztautau->Process("Selection.C+","Ztautau");
  }// option 2
  ...
  if (option==3 || option==0)   {
    ...
    chain_single_top_tchan->Process("Selection.C+","single_top_tchan");
    ...
    chain_single_antitop_tchan->Process("Selection.C+","single_antitop_tchan");
    ...
    chain_single_top_schan->Process("Selection.C+","single_top_schan");
    ...
    chain_single_antitop_schan->Process("Selection.C+","single_antitop_schan");
    ...
    chain_single_top_wtchan->Process("Selection.C+","single_top_wtchan");
    ...
    chain_single_antitop_wtchan->Process("Selection.C+","single_antitop_wtchan");
    ...
    chain_ttbar_lep->Process("Selection.C+","ttbar_lep");
  ...
  chain_Wplusenu->Process("Selection.C+","Wplusenu");
  ...
  chain_Wplusmunu->Process("Selection.C+","Wplusmunu");
  ...
  chain_Wplustaunu->Process("Selection.C+","Wplustaunu");
  } // option 4
  ...
  chain_Wminusenu->Process("Selection.C+","Wminusenu");
  ...
  chain_Wminusmunu->Process("Selection.C+","Wminusmunu");
  ...
  chain_Wminustaunu->Process("Selection.C+","Wminustaunu");
  } // option 5
